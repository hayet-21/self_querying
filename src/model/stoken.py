...
from ptoken import load_embedding_function, initialize_vectorstore, initialize_retriever, query_bot
...
def parse_file(filepath, parser=pdf_chain):
    ...
    print('nombre de token du fichier pdf brute : ',num_tokens_from_string(text))
...
print('nombre de token du fichier pdf parser : ',num_tokens_from_string(extracted_text))

if query:
    full_query= f"{query}\n{extracted_text}"
    print('nombre de token du fichier pdf parser et query : ',num_tokens_from_string(full_query))
    ...
    print('nombre de token du resultat final : ',num_tokens_from_string(result))
